...
public class ANDFieldValidation3 extends Login {
	...
	public void SpecialCharacters() {
		...
		try {
			Thread.sleep(30000);
			driver.findElement(By.id("api_checkbox"));
		} catch (Exception e1) {

			System.out.println("Emprty page ");
			e1.printStackTrace();
		}
		...
		js.executeScript("arguments[0].scrollIntoView();",
				driver.findElement(By.xpath("//*[@id=\"Pnopopup2\"]//span[@ng-click=\"popupclose()\"]")));
		driver.findElement(By.xpath("//*[@id=\"Pnopopup2\"]//span[@ng-click=\"popupclose()\"]")).click();
		System.out.println("Special characters completed...");
	}
